...
export interface RoutingRecipient {id:string;name:string;kind:'employee'|'department'|'group';action:string;access:string;dueDate?:string;replyRequired:boolean;note?:string;sentAt?:string;receivedAt?:string;viewedAt?:string}
